<%@ Page Title="" Language="C#" MasterPageFile="~/govsec/include/MasterPage.master" AutoEventWireup="true" CodeFile="BookGridViewUpadteA.aspx.cs" Inherits="govsec_include_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="no" DataSourceID="AccessDataSource1" 
        EmptyDataText="沒有資料錄可顯示。" Font-Size="Medium">
        <Columns>
